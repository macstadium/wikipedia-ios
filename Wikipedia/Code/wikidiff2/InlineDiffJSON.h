...
protected:
    ...
    void printWordDiff(const String& text1, const String& text2,
        int leftLine, int rightLine, const int sectionTitleIndex, bool printLeft = true, bool printRight = true,
    ...
    void appendSectionTitleIndex(const int sectionTitleIndex);
