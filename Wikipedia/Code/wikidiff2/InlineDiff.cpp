...
void InlineDiff::printAdd(const String& line, int leftLine, int rightLine, const int sectionTitleIndex)
{
    if(line.empty()) {
...
void InlineDiff::printDelete(const String& line, int leftLine, int rightLine, const int sectionTitleIndex)
{
    if(line.empty()) {
...
void InlineDiff::printWordDiff(const String& text1, const String& text2, int leftLine, int rightLine, const int sectionTitleIndex, bool printLeft, bool printRight, const String & srcAnchor, const String & dstAnchor, bool moveDirectionDownwards)
{
...
void InlineDiff::printContext(const String & input, int leftLine, int rightLine, const int sectionTitleIndex)
{
